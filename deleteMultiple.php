...
if ((isset($_GET['id'])) && ($_GET['id'] != "")) {
  ...
  $deleteSQL = sprintf("DELETE FROM material,file USING material,file WHERE material.id=%s AND material.id=file.id", 
...
if (isset($_SERVER['QUERY_STRING'])) {
	// 2010.12.28 16:49 comment the $deleteGoto .= lines
